const Devolucion = require('../models/devolucionesModel'); // Asegúrate de que la ruta sea correcta
...
exports.createDevolucion = async (req, res) => {
    const { cedula, codigo_barras, nombre_producto, fecha_compra, fecha_devolucion, cantidad, precio, monto_total, motivo, estado_envio, estado_pedido } = req.body;
